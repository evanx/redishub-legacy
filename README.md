...
Currently a multi-tenanted Redis instance on a 512Mb Digital Ocean VM. Perhaps down the line, a Redis Cluster, complemented by a disk-based implementation such as http://ssdb.io, for archival purposes, and high-volume free accounts to reduce costs.
